...
- `examples/html-css-app/` — **reproducao RODAVEL das 9 telas** acima (SPA HTML+CSS+JS sem build): roteamento por hash, animacoes de entrada/troca de tela e biblioteca de graficos propria (`charts.js`). Melhor referencia quando precisar de um app multi-tela completo e navegavel; ver `examples/html-css-app/README.md`.
